...
If you're a beginner in quantitative UX research I definitely recommend this book. For more experienced researchers, this may only be useful if you're interested in exploring the HEART framework, sunburst diagrams, specific survey techniques (such as customer satisfaction surveys and MaxDiff), or gaining a basic understanding of the work of a quantitative UX researcher. The book is well-structured, easy to read, and provides a lot of references for further reading. Some of them I'll take to my reading list:
